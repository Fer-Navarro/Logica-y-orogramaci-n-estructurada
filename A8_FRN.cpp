...
void bajas()
{
    ...
    if (encontrado==false){
                cout<<"\n\tNo se encontro ningún registro con la clave: "<<auxclave<<"\n\n\t\t\t";
            }
...
void buscar()
{
    ...
    if (lectura.is_open()){
        ...
        cout<<"\n\tAún no se pudo abrir el archivo...";
    }
        ...
        cin>>auxclave;
            ...
            while (!lectura.eof()){
                ...
                if (auxclave==clave){
                    ...
                    cin>>auxnombre;
                    cout<<"\tIngresa el semestre: "<<semestre<<"\n\n\t---> ";
                    cin>>semestre;
                    cout<<"\tIngresa el grupo: "<<grupo<<"\n\n\t---> ";
                    cin>>grupo;
                    cout<<"\tIngresa la edad: "<<edad<<"\n\n\t---> ";
                    cin>>edad;
...
int main()
{
    ...
    cout<<"\n\tCreado por Fernanda Rivas Proyecto integrador\n\n";
    cout<<"\n\t1.-Altas";
    cout<<"\n\t2.-Bajas";
    cout<<"\n\t3.-Consultas";
...
default:{
    cout<<"\n\n\tHa elegido una opción inexistente...\n\n\t\t"; system ("pause");
    break;
}
    }//fin switch
